...
export const CartProvider = ({ children }) => {
  ...
  const addToCart = (item, quantity) => {
    setCart(prevCart => {
      const existingItemIndex = prevCart.findIndex(cartItem => cartItem.variety === item.variety);
      ...
      if (existingItemIndex > -1) {
        ...
        updatedItem.totalAmount = updatedItem.quantity * updatedItem.rate_per_unit;
  ...
  return (
    <CartContext.Provider value={{ cart, addToCart, removeFromCart, clearCart, getTotalCost }}>
      {children}
